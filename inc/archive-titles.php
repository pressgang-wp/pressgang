...
class ArchiveTitles {
	...
	public static function customizer( $wp_customize ) {
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'archives_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_cat_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_tag_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_author_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_year_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_month_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'single_day_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'post_type_archive_title', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'search_results_title', [
