...
class HeapAnalytics {
	...
	public function customizer( $wp_customize ) {
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'heap-analytics-id', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'heap-analytics-track-logged-in', [
