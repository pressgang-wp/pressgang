...
class TrackPostViews {
	...
	public function __construct() {
		...
		add_action( 'wp_head', array( $this, 'cache_breaker' ) );
		add_action( 'the_post', array( $this, 'add_views_to_post' ) );
	 ...
	 * @return \WP_Query
	 */
	public function get_most_popular( $post_type = 'post', $number = 0, $paged = 0 ) {
