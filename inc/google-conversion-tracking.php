...
class GoogleConversionTracking {
	...
	public function customizer( $wp_customize ) {
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'google-adwords-id', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'google-conversion-label', [
