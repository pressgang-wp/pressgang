...
class AcfWcProductAttributes {
	...
	public function __construct() {
		\add_filter( 'acf/location/rule_types', [ $this, 'acf_location_rules_operators' ] );
		\add_filter( 'acf/location/rule_values/wc_prod_attr', [ $this, 'acf_location_rule_values' ] );
		\add_filter( 'acf/location/rule_values/wc_prod_attr', [ $this, 'acf_location_rule_match' ], 10, 4 );
	}
