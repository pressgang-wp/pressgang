...
class GoogleAnalytics {
	...
	public function customizer( $wp_customize ) {
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'google-analytics-id', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'track-logged-in', [
