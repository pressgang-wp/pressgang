...
class Hotjar {
	...
	public function customizer( $wp_customize ) {
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'hotjar-id', [
		...
		$wp_customize->add_control( new \WP_Customize_Control( $wp_customize, 'hotjar-track-logged-in', [
