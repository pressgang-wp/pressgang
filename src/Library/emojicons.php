...
use function PressGang\remove_filter;
...
class Emojicons {
	...
	public static function init() {
		add_action( 'init', array( 'PressGang\Libarary\Emojicons', 'disable' ) );
	}
	...
	public static function disable() {
		...
		add_filter( 'tiny_mce_plugins', array( 'PressGang\Libarary\Emojicons', 'disable_emojicons_tinymce' ) );
	}
