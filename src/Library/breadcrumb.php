...
use function PressGang\get_month_link;
use function PressGang\get_permalink;
use function PressGang\get_post_ancestors;
use function PressGang\get_post_type;
use function PressGang\get_post_type_archive_link;
use function PressGang\get_post_type_object;
use function PressGang\get_query_var;
use function PressGang\get_search_query;
use function PressGang\get_site_url;
use function PressGang\get_term_link;
use function PressGang\get_terms;
use function PressGang\get_the_category;
use function PressGang\get_the_terms;
use function PressGang\get_the_time;
use function PressGang\get_the_title;
use function PressGang\get_userdata;
use function PressGang\get_year_link;
use function PressGang\is_404;
use function PressGang\is_archive;
use function PressGang\is_author;
use function PressGang\is_category;
use function PressGang\is_day;
use function PressGang\is_front_page;
use function PressGang\is_month;
use function PressGang\is_page;
use function PressGang\is_search;
use function PressGang\is_single;
use function PressGang\is_tag;
use function PressGang\is_tax;
use function PressGang\is_year;
use function PressGang\single_cat_title;
use function PressGang\taxonomy_exists;
