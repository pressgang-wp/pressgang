...
use function PressGang\add_rewrite_rule;
use function PressGang\apply_filters;
use function PressGang\get_field;
use function PressGang\get_permalink;
use function PressGang\get_post_modified_time;
use function PressGang\get_post_types;
use function PressGang\get_taxonomies;
use function PressGang\get_term_link;
use function PressGang\is_multisite;
use function PressGang\wpml_get_active_languages_filter;
use function PressGang\wpml_object_id_filter;
