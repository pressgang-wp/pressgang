...
use function PressGang\absint;
use function PressGang\add_action;
use function PressGang\add_filter;
use function PressGang\add_post_meta;
use function PressGang\current_user_can;
use function PressGang\get_current_screen;
use function PressGang\get_object_taxonomies;
use function PressGang\get_post;
use function PressGang\get_post_meta;
use function PressGang\wp_die;
use function PressGang\wp_get_current_user;
use function PressGang\wp_get_object_terms;
use function PressGang\wp_insert_post;
use function PressGang\wp_nonce_url;
use function PressGang\wp_safe_redirect;
use function PressGang\wp_set_object_terms;
use function PressGang\wp_verify_nonce;
