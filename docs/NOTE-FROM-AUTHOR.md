...
There's no attempt to hide WordPress, replace it, or abstract it beyond recognition — the goal is to work _with_ WordPress, but in a way that feels modern, explicit, and maintainable.
